...
class ADMIN
{
    ...
    public function insert_order($data){
        $stmt = $this->conn->prepare("INSERT INTO customers(first_name, last_name, email, cardnumber, securitycode, address, zip) VALUES(:first_name, :last_name, :email, :cardnumber, :securitycode, :address, :zip");
        $stmt->execute(array(
